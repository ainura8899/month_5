...
urlpatterns = [
    ...
    path('api/v1/movies/<int:id>/', views.movie_detail_api_view), #G ET→item, PUT→update, DELETE→destroy
    path('api/v1/directors/', views.director_list_api_view), # GET→list, POST→create
    path('api/v1/directors/<int:id>/', views.director_detail_api_view),# GET→item, PUT→update, DELETE→destroy
    path('api/v1/reviews/', views.review_list_api_view), # GET→list, POST→create
